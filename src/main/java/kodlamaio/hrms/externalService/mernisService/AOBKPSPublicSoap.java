...
public class AOBKPSPublicSoap
{
    ...
    public AOBKPSPublicSoap(){}

    public AOBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AOBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AOBExtendedSoapSerializationEnvelope envelope= new AOBExtendedSoapSerializationEnvelope(AOBExtendedSoapSerializationEnvelope.VER11);
