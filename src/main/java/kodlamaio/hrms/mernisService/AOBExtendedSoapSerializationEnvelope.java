...
public class AOBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AOBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AOBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AOBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AOBDateTimeConverter dateTimeConverter = new AOBStandardDateTimeConverter();

    public AOBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AOBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AOBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AOBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AOBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AOBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
